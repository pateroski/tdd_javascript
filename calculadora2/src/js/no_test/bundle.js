(function e(t, n, r) {
  ...
  2: [function(require, module, exports) {
    ...
    function alertarAreaCuadrado() {
      $('#resultCuadrado').text("  El area es : " + area.areaCuadrado($(
        '#lado').val()));
      resetResults('#resultCuadrado');
    }

    function alertarAreaCirculo() {
      $('#resultCirculo').text("  El area es : " + area.areaCirculo($(
        '#radio').val()));
      resetResults('#resultCirculo');
    }

    function alertarVolumenCuadrado() {
      $('#resultCuadrado').text("  El volumen es : " + volume.volumenCubo(
        $('#lado').val(), area));
      resetResults('#resultCuadrado');
    }
  ...
  3: [function(require, module, exports) {
    ...
    var volumeModule = (function() {
      var area = require('./area.js');
      return {
        volumenCubo: function(lado) {
          return area.areaCuadrado(lado) * lado;
        },
        volumenEsfera: function(radio) {
          return area.areaCirculo(radio) * radio * ((4 / 3).toFixed(
            2));
        }
      };
    })();
    ...
    (function(global, factory) {
      ...
      var Sizzle =
        ...
        (function(window) {
              ...
              if (nodeType !== 11 && (match = rquickExpr.exec(
                ...
                if ((m = match[1])) {
                  if (nodeType === 9) {
                    ...
                    if (context.ownerDocument && (elem = context.ownerDocument
                        .getElementById(m)) &&
                ...
                return pattern ||
                  ...
                  classCache(className, function(elem) {
                    return pattern.test(typeof elem.className ===
                      "string" && elem.className || typeof elem
                      .getAttribute !== "undefined" && elem
                      .getAttribute("class") || "");
                  });
              },
                  ...
                  function(elem, context, xml) {
                    ...
                    if (parent) {
                      ...
                      if (forward && useCache) {
                        ...
                        outerCache = parent[expando] || (parent[
                          expando] = {});
                ...
                return function(elem) {
                  ...
                  do {
                    if ((elemLang = documentIsHTML ?
                      ...
                      return elemLang === lang || elemLang.indexOf(
                        lang + "-") === 0;
                    }
                  } while ((elem = elem.parentNode) && elem
                    .nodeType === 1);
                  return false;
                };
              }),
              ...
              if ((matcher = Expr.relative[tokens[i].type])) {
                ...
                if (matcher[expando]) {
                  ...
                  return setMatcher(
                    ...
                    j < len && matcherFromTokens((tokens = tokens
                      .slice(j))),
          ...
          support.sortDetached = assert(function(div1) {
            ...
            return div1.compareDocumentPosition(document.createElement(
              "div")) & 1;
          });
          ...
          if (!support.attributes || !assert(function(div) {
            ...
            addHandle("value", function(elem, name, isXML) {
              if (!isXML && elem.nodeName.toLowerCase() ===
                "input") {
      ...
      jQuery.fn.extend({
        find: function(selector) {
          ...
          ret = this.pushStack(len > 1 ? jQuery.unique(ret) :
            ret);
      ...
      var access = jQuery.access = function(elems, fn, key, value,
        ...
        if (jQuery.type(key) === "object") {
          ...
          if (fn) {
            for (; i < len; i++) {
              fn(elems[i], key, raw ? value : value.call(elems[i],
                i, fn(elems[i], key)));
            }
          }
        }
          ...
          if (key === undefined) {
            ...
            if (jQuery.isArray(key)) {
              ...
              if (key in cache) {
                ...
                name = camel;
                name = name in cache ? [name] : (name.match(
                  rnotwhite) || []);
              }
            }
          ...
          if (elem) {
            ...
            if (data) {
              if (!queue || jQuery.isArray(data)) {
                queue = data_priv.access(elem, type, jQuery.makeArray(
                  data));
              } else {
                queue.push(data);
              }
          ...
          return data_priv.get(elem, key) || data_priv.access(
            elem, key, {
              empty: jQuery.Callbacks("once memory").add(
                function() {
                  data_priv.remove(elem, [type + "queue",
                    key
                  ]);
                })
            });
      ...
      jQuery.event = {
        ...
        add: function(elem, types, handler, data, selector) {
          ...
          if (!(eventHandle = elemData.handle)) {
            eventHandle = elemData.handle = function(e) {
              ...
              return typeof jQuery !== strundefined && jQuery.event
                .triggered !== e.type ?
        ...
        trigger: function(event, data, elem, onlyHandlers) {
          ...
          var i, cur, tmp, bubbleType, ontype, handle, special,
            ...
            event,
            namespaces = hasOwn.call(event, "namespace") ? event.namespace
            .split(".") : [];
      ...
      function manipulationTarget(elem, content) {
        return jQuery.nodeName(elem, "table") &&
          jQuery.nodeName(content.nodeType !== 11 ? content : content
            .firstChild, "tr") ?
      ...
      function disableScript(elem) {
        elem.type = (elem.getAttribute("type") !== null) + "/" + elem
          .type;
        return elem;
      }
      ...
      function setGlobalEval(elems, refElements) {
        ...
        for (; i < l; i++) {
          data_priv.set(
            elems[i], "globalEval", !refElements || data_priv.get(
      ...
      function cloneCopyEvent(src, dest) {
        var i, l, type, pdataOld, pdataCur, udataOld, udataCur,
          events;
      ...
      function actualDisplay(name, doc) {
        var style,
          ...
          display = window.getDefaultComputedStyle && (style = window
        ...
        style: function(elem, name, value, extra) {
          ...
          if (value !== undefined) {
            ...
            if (type === "string" && (ret = rrelNum.exec(value))) {
              value = (ret[1] + 1) * ret[2] + parseFloat(jQuery
                .css(elem, name));
              // Fixes bug #9237
              type = "number";
            }
          ...
          set: function(tween) {
            ...
            if (jQuery.fx.step[tween.prop]) {
              jQuery.fx.step[tween.prop](tween);
                ...
                jQuery.cssProps[tween.prop]] != null || jQuery.cssHooks[
                tween.prop])) {
      ...
      function defaultPrefilter(elem, props, opts) {
        ...
        if (!jQuery.isEmptyObject(orig)) {
          ...
          for (prop in orig) {
            tween = createTween(hidden ? dataShow[prop] : 0, prop,
              anim);
          ...
          animation = deferred.promise({
            ...
            createTween: function(prop, end) {
              var tween = jQuery.Tween(elem, animation.opts, prop,
                ...
                animation.opts.specialEasing[prop] || animation
                .opts.easing);
        ...
        stop: function(type, clearQueue, gotoEnd) {
          ...
          return this.each(function() {
            ...
            if (index) {
              ...
              for (index in data) {
                if (data[index] && data[index].stop && rrun
                  .test(index)) {
                  stopQueue(data[index]);
                }
              }
      ...
      jQuery.param = function(a, traditional) {
        ...
        if (jQuery.isArray(a) || (a.jquery && !jQuery.isPlainObject(
            a))) {
        ...
        var callbackName, overwritten, responseContainer,
          jsonProp = s.jsonp !== false && (rjsonp.test(s.url) ?
            ...
            typeof s.data === "string" && !(s.contentType || "").indexOf(
              "application/x-www-form-urlencoded") && rjsonp.test(
              s.data) && "data"
          );
