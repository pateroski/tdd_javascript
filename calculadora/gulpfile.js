//'use strict';
// generated on 2016-04-06 using generator-cg-gas 3.3.4
...
//update webdriver if necessary, this task will be used by  task
...
// run unit tests with jenkins CI
gulp.task('jenkins', ['build'], function(cb) {
  karma.start(_.assign({}, karmaConfig, {
    singleRun: true,
    browsers: ['PhantomJS']
  }), cb);
...
gulp.task('build', ['clean'], function(cb) {
  runSequence(['templates','wiredep'], cb);
});
